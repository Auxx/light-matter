...
describe('FlatButtonComponent', () => {
  ...
  describe('variant', () => {
    it('should update color based on variant value', () => {
      ...
      expect(styles.getPropertyValue('--text-color')).toBe('var(--color-contrast-default-highest)');
      expect(styles.getPropertyValue('--disabled-text-color')).toBe('var(--color-contrast-default-low)');
      expect(styles.getPropertyValue('--background-color')).toBe('var(--color-element-default-low)');
      expect(styles.getPropertyValue('--disabled-background-color')).toBe('var(--color-element-default-high)');

      fixture.componentRef.setInput('variant', 'primary');
      fixture.detectChanges();
      expect(styles.getPropertyValue('--text-color')).toBe('var(--color-contrast-primary-highest)');
      expect(styles.getPropertyValue('--disabled-text-color')).toBe('var(--color-contrast-primary-low)');
      expect(styles.getPropertyValue('--background-color')).toBe('var(--color-element-primary-low)');
      expect(styles.getPropertyValue('--disabled-background-color')).toBe('var(--color-element-primary-high)');

      fixture.componentRef.setInput('variant', 'warn');
      fixture.detectChanges();
      expect(styles.getPropertyValue('--text-color')).toBe('var(--color-contrast-warn-highest)');
      expect(styles.getPropertyValue('--disabled-text-color')).toBe('var(--color-contrast-warn-low)');
      expect(styles.getPropertyValue('--background-color')).toBe('var(--color-element-warn-low)');
      expect(styles.getPropertyValue('--disabled-background-color')).toBe('var(--color-element-warn-high)');
    });
  });
